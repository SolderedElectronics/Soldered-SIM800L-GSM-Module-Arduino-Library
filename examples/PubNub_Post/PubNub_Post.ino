...
void setup()
{
    ...
    if (!deviceCheck) // means an error has occurred
    {
        ...
        while (true)
            ; // here the device won't continue, until this error has been fixed
    }
    ...
    at every following request. Each response will have a brand new timetoken. So you must replace the old timetoken
    each time.

    // Initial Response
    [[],"9718304464409"]

    Take the "timetoken" value and place it in the following request like this and open it in your browser, You will see
    your posted info -
